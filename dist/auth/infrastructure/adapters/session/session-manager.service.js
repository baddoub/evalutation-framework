...
let SessionManagerService = class SessionManagerService {
    constructor(sessionRepository, refreshTokenRepository, tokenService) {
    ...
    async findByRefreshToken(token) {
        ...
        const userId = user_id_vo_1.UserId.fromString(payload.sub);
...
exports.SessionManagerService = SessionManagerService = __decorate([
    ...
    __param(2, (0, common_1.Inject)('ITokenService')),
