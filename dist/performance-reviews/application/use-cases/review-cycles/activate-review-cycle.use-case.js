...
exports.ActivateReviewCycleUseCase = void 0;
const common_1 = require("@nestjs/common");
const review_cycle_id_vo_1 = require("../../../domain/value-objects/review-cycle-id.vo");
let ActivateReviewCycleUseCase = class ActivateReviewCycleUseCase {
...
exports.ActivateReviewCycleUseCase = ActivateReviewCycleUseCase;
exports.ActivateReviewCycleUseCase = ActivateReviewCycleUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)('IReviewCycleRepository')),
    __metadata("design:paramtypes", [Object])
], ActivateReviewCycleUseCase);
//# sourceMappingURL=activate-review-cycle.use-case.js.map